return { -- Fuzzy Finder (files, lsp, etc)
	...
	config = function()
		...
		vim.keymap.set("n", "<leader>dd", builtin.diagnostics, { buffer = true, desc = "[D]iagnostics [D]ocument" })

		-- Files
		vim.keymap.set("n", "<leader><space>", builtin.find_files, { desc = "Smart file finder" })
